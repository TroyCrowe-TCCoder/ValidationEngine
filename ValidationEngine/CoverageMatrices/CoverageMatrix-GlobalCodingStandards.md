...
| coding.3.8 | Comments explain why, not what; no restating what code already says | Development | Manual-only | Manual-only-comment | Every-Commit | Requires semantic judgment about comment content relative to code; not reliably automatable | Missing |
